...
import { selectSort, setSort, SortPropEnum } from '../redux/slices/filterSlice';
...
export const sortList: SortItem[] = [
    { name: 'популярности (desc)', sortProperty: SortPropEnum.RATING_DESC },
    { name: 'популярности (asc)', sortProperty: SortPropEnum.RATING_ASC },
